function mix = gmminit1(mix, x, options)
...
[idx, mix.centres] = kmeans(x,mix.ncentres,'start','sample','maxiter',100,...
  'emptyaction','singleton','replicates',100,'display',kmeansdisp);
post = zeros(ndata,mix.ncentres);
post(sub2ind(size(post),1:ndata,idx')) = 1;
