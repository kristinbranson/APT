...
%         w = w(:);        
    ...
    function [trk1save,trk2save] = viewPreferenceTriangulate(trk1,trk2,...
        rois,crig,pp3dtype,varargin)
      %
      ...
      switch pp3dtype
        case 'triangulate'
          ...
          fprintf(1,'Save/appended variables ''pTrkSingleView'', ''pTrk'', ''pTrk3d''.\n');
          %trkfiles{1});
          %save(trkfiles{2},'-append','-struct','trk2save');
          fprintf(1,'Save/appended variables ''pTrkSingleView'', ''pTrk''.\n');
          %trkfiles{2});
