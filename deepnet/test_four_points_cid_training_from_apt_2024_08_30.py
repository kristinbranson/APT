...
def test_training() :
    ...
    read_only_folder_path = os.path.join(project_folder_path, "four-points", "four-points-cid-training-2024-08-30-input-folder-read-only")
    working_folder_path = os.path.join(project_folder_path, "four-points", "four-points-cid-training-2024-08-30-working-folder")
    ...
    with cd(deepnet_folder_path):
        APT_interface.main(
            [os.path.join(working_folder_path,'four_points_180806/20240830T172814_20240830T172814.json'),
             '-name', '20240830T172814', 
             '-err_file', os.path.join(working_folder_path,
                                       'four_points_180806/20240830T172814view0_20240830T172814_bu.err'),
