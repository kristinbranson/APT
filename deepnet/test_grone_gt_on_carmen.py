...
def test_whatever() :
    ...
    read_only_folder_path = os.path.join("/groups/branson/bransonlab/taylora/apt/carmen-gt-repro-read-only")
    working_folder_path = os.path.join("/groups/branson/bransonlab/taylora/apt/carmen-gt-repro")
