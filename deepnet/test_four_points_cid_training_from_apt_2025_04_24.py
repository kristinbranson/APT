...
def test_training() :
    ...
    read_only_folder_path = "/groups/branson/bransonlab/taylora/apt/repro-files/four-points-cid-2025-04-24/test-files-read-only"
    working_folder_path = "/groups/branson/bransonlab/taylora/apt/repro-files/four-points-cid-2025-04-24/test-files-working"
    ...
    with cd(deepnet_folder_path):
        APT_interface.main(
            [os.path.join(working_folder_path,'fourpoints512/20250424T171539_20250424T171539.json'),
             '-name', '20250424T171539', 
             '-err_file', os.path.join(working_folder_path,
                                       'fourpoints512/20250424T171539view0_20250424T171539_bu.err'),
