cmd = '/nrs/branson/mayank/apt_cache_2/four_points_180806/20210326T070533_20210326T070535.lbl -conf_params db_format \"coco\" mmpose_net \"higherhrnet\" dl_steps 100000 save_step 10000 batch_size 8 max_n_animals 2 op_affinity_graph \(\(0,1\),\(0,2\),\(0,3\)\) rrange 180 trange 30 is_multi True multi_use_mask False multi_loss_mask True multi_crop_ims False mmdetect_net \"detr\" rescale 4 -json_trn_file /nrs/branson/mayank/apt_cache_2/four_points_180806/loc_split_neg_tight.json -type detect_mmdetect -model_files /groups/branson/bransonlab/mayank/APT/deepnet/mmdetection/checkpoints/detr_r50_8x2_150e_coco_20201130_194835-2c4b8974.pth -train_name detr -name roian_split_bbox_mmdetect_multi -cache /nrs/branson/mayank/apt_cache_2 train -use_cache -skip_db'
from reuse import *
cmd = cmd.replace('\\','')
apt.main(cmd.split())
