cmd = '/nrs/branson/mayank/apt_cache_2/alice_ma/alice_ma.lbl_multianimal.lbl -conf_params db_format \"coco\" mmpose_net \"higherhrnet\" dl_steps 20000 save_step 10000 batch_size 3 max_n_animals 10 is_multi True multi_use_mask False multi_loss_mask True multi_crop_ims False mmdetect_net \"detr\" rescale 4 mmdetect_use_default_sz True -json_trn_file /groups/branson/home/kabram/nrs/apt_cache_2/alice_ma/loc_split_neg.json -type detect_mmdetect -train_name detr_autoaug_20k_rand_neg -name alice_split_bbox_mmdetect_multi -cache /nrs/branson/mayank/apt_cache_2 train -use_cache -skip_db'
from reuse import *
cmd = cmd.replace('\\','')
apt.main(cmd.split())
