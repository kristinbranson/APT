cmd = '/nrs/branson/mayank/apt_cache_2/alice_ma/alice_ma.lbl_multianimal.lbl -conf_params db_format \"coco\" mmpose_net \"higherhrnet\" dl_steps 100000 save_step 10000 batch_size 8 max_n_animals 10 op_affinity_graph \(\(0,1\),\(0,5\),\(1,2\),\(3,4\),\(3,5\),\(5,6\),\(5,7\),\(5,9\),\(3,16\),\(9,10\),\(10,15\),\(9,14\),\(4,11\),\(7,8\),\(8,12\),\(7,13\)\) rrange 180 trange 30 is_multi True multi_use_mask False multi_loss_mask True multi_crop_ims False mmdetect_net \"detr\" rescale 2 -json_trn_file /nrs/branson/mayank/apt_cache_2/alice_ma/loc_split_neg_axis_aligned.json -type detect_mmdetect -train_name detr -name alice_split_bbox_mmdetect_multi -cache /nrs/branson/mayank/apt_cache_2 train -use_cache -skip_db'
from reuse import *
cmd = cmd.replace('\\','')
apt.main(cmd.split())
