...
lbl_file = '/groups/branson/bransonlab/apt/experiments/data/sh_trn5017_20200121_stripped.lbl'
name = 'stephen_20200124'
...
#                 predLocs[:,:,1] += orig_crop_loc[0] # y
            ...
            if args.track and view == 1:
                ...
                # scriptf.write('fi\n')
                scriptf.write('export MCR_CACHE_ROOT=/scratch/%s/mcrcache%s\n'%(username,jobid))
