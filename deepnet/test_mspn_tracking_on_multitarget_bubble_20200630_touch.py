...
def test_mspn_tracking_on_multitarget_bubble_20200630_touch() :
    ...
    read_only_folder_path = os.path.join(project_folder_path, "read_only_mspn_multitarget_bubble_20200630_touch_tracking_test_input_folder")
    working_folder_path = os.path.join(project_folder_path, "ampere_mspn_multitarget_bubble_20200630_touch_tracking_test_working_folder")
