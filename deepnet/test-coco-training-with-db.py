...
def test_training() :
    ...
    read_only_folder_path = os.path.join(project_folder_path, "coco/coco-input-folder-with-db-read-only")
    working_folder_path = os.path.join(project_folder_path, "coco/coco-working-folder-with-db")
