...
def test_training() :
    ...
    read_only_folder_path = os.path.join(project_folder_path, "four-points-from-apt-input-folder-read-only")
    working_folder_path = os.path.join(project_folder_path, "four-points-from-apt-working-folder")
    ...
    with cd(deepnet_folder_path):
        APT_interface.main(
            [os.path.join(working_folder_path,'four_points_180806/20231002T194232_20231002T194232.json'),
             '-name', '20231002T194232', 
             '-err_file', os.path.join(working_folder_path,
                                       'four_points_180806/20231002T194232view0_20231002T194232_bu.err'),
