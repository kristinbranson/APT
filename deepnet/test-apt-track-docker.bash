...
TEST_SCRIPT_PATH="${SCRIPT_FOLDER_PATH}/apt-track-wrapper"
...
${TEST_SCRIPT_PATH} -docker -lbl_file ${LABEL_FILE_PATH} -mov ${VIDEO_FILE_PATH} -start_frame 1 -end_frame 200 -out ${OUTPUT_FILE_PATH}
