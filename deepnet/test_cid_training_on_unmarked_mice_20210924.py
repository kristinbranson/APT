...
def test_training() :
    ...
    read_only_folder_path = os.path.join(project_folder_path, "unmarkedMice_round2_cid_training_test_input_folder_read_only")
    working_folder_path = os.path.join(project_folder_path, "unmarkedMice_round2_cid_training_test_working_folder")
    ...
    with cd(deepnet_folder_path) :
        APT_interface.main(
            [os.path.join(working_folder_path,'unmarkedMice/20230821T114207_20230821T114207.json'),
             '-name', '20230821T114207', 
             '-err_file', os.path.join(working_folder_path, 'unmarkedMice/20230821T114207view0_20230821T114207_bu.err'),
             '-json_trn_file', os.path.join(working_folder_path, 'unmarkedMice/loc.json'), 
