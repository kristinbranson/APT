...
def test_training() :
    ...
    read_only_folder_path = os.path.join(project_folder_path, "coco/coco-input-folder-ready-to-train-read-only")
    working_folder_path = os.path.join(project_folder_path, "coco/coco-working-folder-ready-to-train")
