...
axis off
hold on
p1h=plot(pT(1,1:2),pT(1,5:6),'xr','MarkerSize',8,'LineWidth',2);
p2h=plot(pT(1,3:4),pT(1,7:8),'xg','MarkerSize',8,'LineWidth',2);
p12h=plot([m1Cx(1),m2Cx(1)],[m1Cy(1),m2Cy(1)],'m','LineWidth',1.5);


subplot(2,3,3);
axis([1 size(pT,1) min([m1L;m2L])*0.95 max([m1L;m2L])*1.05])
hold on
pLh=plot(1,m1L(1),'r',1,m2L(1),'g');
set(pLh,'LineWidth',2)
