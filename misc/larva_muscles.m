function [pTr,lossTr,pT,lossT,regModel,regPrm,prunePrm]=larva_muscles(phisTr,bboxesTr,IsTr,phisT,bboxesT,IsT)
...
elseif cpr_type==2
    ftrPrm = struct('type',5,'F',400,'nChn',1,'radius',1.5);
...
testPrm = struct('RT1',RT1,'pInit',bboxesT,...
    ...
    'verbose',1);
%Test
t=clock;[pT,pRT] = rcprTest(IsT,regModel,testPrm);t=etime(clock,t);
%Round up the pixel positions
pT(:,1:nfids*2)=round(pT(:,1:nfids*2));
%Compute loss
