...
defaultfile = 'M118_M119_M122_M127_M130_M174_20150423.mat';
...
for tmpj = 1:numel(olds),
  ld.expdirs = strrep(ld.expdirs,olds{tmpj},news{tmpj});
...
for i = 1:numel(ld.expdirs),
  assert(exist(ld.expdirs{i},'file')>0);
end
if isfield(ld,'fixedlabels'),
  for i = 1:numel(ld.fixedlabels.expdirs),
    assert(exist(ld.fixedlabels.expdirs{i},'file')>0);
  end
end
...
paramsfile2 = sprintf('TrainParams_%s_2D_20150427.mat',savestr);
