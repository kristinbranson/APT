...
%     end
  ...
  methods
    ...
    function bgTrnStart(obj,backEnd,dmcs)
      ...
      nvw = obj.lObj.nview;
      assert((numel(dmcs) == 1 && isempty(dmcs.view)) || numel(dmcs)==nvw);
      ...
      switch backEnd.type
        case DLBackEnd.Bsub
          ...
          for ivw=1:nvw
            ...
            dmc(ivw).modelChainID = [modelChainID,'_view',num2str(dmc(ivw).view)];
...
%         end        
    ...
    function codestr = trackCodeGenBase(trnID,dllbl,errfile,nettype,movtrk,...
      ...
      if ~isempty(model_file),
        codestr = sprintf('%s -model_files %s',codestr,cell2spacedargs(model_file));
      end
