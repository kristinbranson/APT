...
from ray_tracing_simulator_nnModules_grad_nan_masks import Prism, Ray, Plane, ReflectingPlane, RefractingPlane, EfficientCamera, visualize_camera_configuration, closest_point, rotx, get_rot_mat
...
class Arena_reprojection_loss_two_cameras_prism_grid_distances(nn.Module):
    ...
    def get_prism_corners(self):
        if not self.prism_rotation_6d is None:
