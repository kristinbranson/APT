function [hfig,savename,sortederrs] = PlotFracInliersPerLandmark(varargin)
...
alllegendnames = [legendnames(:);statname];
...
if dosavefig,
  if isempty(savename),
    savename = fullfile(savedir,sprintf('%s_GTFracInliers_%s_AllLandmarka.svg',exptype,net));
  end
