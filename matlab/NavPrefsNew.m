...
'TooltipString','Number of frames to skip when using up/down arrows',...
'CreateFcn', {@local_CreateFcn, blanks(0), appdata} ,...
'Tag','etFrameSkip',...
'FontSize',13.3333333333333);
...
'TooltipMode',get(0,'defaultuicontrolTooltipMode'),...
'TooltipString','Number of frames shown during segment/loop playback',...
'ButtonDownFcn',blanks(0),...
'CreateFcn', {@local_CreateFcn, blanks(0), appdata} ,...
'DeleteFcn',blanks(0),...
...
'ForegroundColor',get(0,'defaultuicontrolForegroundColor'),...
'Enable',get(0,'defaultuicontrolEnable'),...
'TooltipString','Comparison operator for timeline statistic',...
...
'ForegroundColor',get(0,'defaultuicontrolForegroundColor'),...
'Enable',get(0,'defaultuicontrolEnable'),...
'TooltipString','Threshold for timeline statistics during seek',...
'TooltipStringMode',get(0,'defaultuicontrolTooltipStringMode'),...
'Visible',get(0,'defaultuicontrolVisible'),...
'HandleVisibility',get(0,'defaultuicontrolHandleVisibility'),...
'ButtonDownFcn',blanks(0),...
