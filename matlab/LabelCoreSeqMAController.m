...
% events.
  ...
  methods
    ...
    function addMAbuttons(obj)
      % Create New Target and Remove Target pushbuttons. Copies units and
      % font properties from the ROI buttons, so must be called after
      % roiAddButtons().
    ...
    function layoutControls(obj)
      ...
      delTgtPos = obj.pbRoiEdit_.Position ;
      delTgtPos(2) = delTgtPos(2) + delTgtPos(4) + YOFF_PIXELS ;
      obj.pbDelTgt_.Position = delTgtPos ;
    end  % function
