...
menuReorder(menu_view_zoom_rotation, ZOOM_VIEW_MENU_ORDER) ;
...
menu_view_showhide_skeleton = ...
  uimenu('Parent',menu_view,...
         'Label','Show skeleton',...
         'Tag','menu_view_showhide_skeleton') ;

menu_view_showhide_labelrois= uimenu('Parent',menu_view,...
...
menuReorder(menu_view_showhide_labelrois, SHOWHIDELABELROIS_VIEW_MENU_ORDER) ;
...
menuReorder(menu_view_showhide_trajectories, TRAJ_VIEW_MENU_ORDER) ;

menu_view_showhide_predictions = uimenu('Parent',menu_view,...
...
menuReorder(menu_view_video_appearance, VIDEO_APPEARANCE_VIEW_MENU_ORDER) ;
...
menuReorder(menu_view, VIEW_MENU_ORDER) ;
...
moveMenuItemAfter(menu_view_show_axes_toolbar,...
  handles.menu_view_video_appearance);
