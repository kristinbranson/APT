...
pushbutton_freezetemplate = uicontrol(...
'Parent',h15,...
'Units',get(0,'defaultuicontrolUnits'),...
'FontUnits','pixels',...
'String','Freeze',...
...
'Tag','pbPlay',...
'FontSize',10.6666666666667,...
'FontSizeMode',get(0,'defaultuicontrolFontSizeMode')); %#ok<NASGU>
...
'Tag','sldZoom',...
'FontSize',10.6666666666667);  %#ok<NASGU>
...
'FontSize',14,...
'FontName',get(0,'defaultuicontrolFontName'));  %#ok<NASGU>
...
menu_file_import_tracking_results = uimenu(...
'Parent',menu_file_import,...
'Label','Import Tracking Results from Trk File (Current Movie)...',...
'Tag','menu_file_import_tracking_results',...
'CreateFcn', '' );  %#ok<NASGU>
...
menu_file_export_all_movies = ...
  uimenu('Parent',menu_file_export,...
         ...
         'Tag','menu_file_export_all_movies');  %#ok<NASGU>
...
menu_file_import_labels_table = ...
  uimenu('Parent',menu_file_import,...
         ...
         'Visible','on','Separator','on') ;  %#ok<NASGU>
...
menu_view_rotate_video_target_up = uimenu('Parent',menu_view_zoom_rotation,...
  ...
  'Tag','menu_view_rotate_video_target_up');  %#ok<NASGU>
...
menu_view_showhide_skeleton = ...
  uimenu('Parent',menu_view_showhide,...
         'Label','Show Skeleton',...
         'Tag','menu_view_showhide_skeleton') ;  %#ok<NASGU>
...
menu_view_showhide_preds_all_targets = ...
  uimenu('Parent',menu_view_showhide_predictions,...
         'Label','All Targets',...
         'Tag','menu_view_showhide_preds_all_targets');  %#ok<NASGU>

menu_view_showhide_preds_curr_target_only = ...
  uimenu('Parent',menu_view_showhide_predictions,...
         'Label','Current Target',...
         'Tag','menu_view_showhide_preds_curr_target_only');  %#ok<NASGU>

menu_view_showhide_preds_none = ...
  uimenu('Parent',menu_view_showhide_predictions,...
         'Label','None',...
         'Tag','menu_view_showhide_preds_none');  %#ok<NASGU>
...
menu_label_sequential_mode = uimenu(...
'Parent',menu_label,...
'Label','Sequential Mode',...
'Tag','menu_label_sequential_mode');  %#ok<NASGU>

menu_label_template_mode = uimenu(...
'Parent',menu_label,...
'Label','Template Mode',...
'Tag','menu_label_template_mode');  %#ok<NASGU>

menu_label_multianimal_mode = ...
  uimenu('Parent',menu_label,...
         'Label','Multianimal Mode',...
         'Tag','menu_label_multianimal_mode');  %#ok<NASGU>

menu_label_multiview_mode = ...
  uimenu('Parent',menu_label,...
         'Label','Multiview Mode',...
         'Tag','menu_label_multiview_mode');  %#ok<NASGU>

menu_label_sequential_add_mode = uimenu('Parent',menu_label,...
  'Label','Add Landmarks Mode',...
  'Tag','menu_label_sequential_add_mode',...
  'Visible','off');  %#ok<NASGU>

menu_label_streamlined = uimenu('Parent',menu_label,...
  'Label','Streamlined',...
  'Tag','menu_label_streamlined',...
  'Separator','on');  %#ok<NASGU>

% not sure what this does
menu_label_use_calibration = uimenu(...
  'Parent',menu_label,...
  'Label','Use Calibration',...
  'Tag','menu_label_use_calibration');  %#ok<NASGU>

menu_label_ma_twoclick_align = uimenu('Parent',menu_label,...
  'Label','Two-Click Animal Alignment',...
  'Tag','menu_label_ma_twoclick_align');  %#ok<NASGU>

menu_label_overlay_montage = ...
  uimenu('Parent',menu_label,...
         'Label','Label Overlay Montage',...
         'Tag','menu_label_overlay_montage',...
         'Separator','on');  %#ok<NASGU>

menu_label_outliers = uimenu('Parent',menu_label,...
  'Label','Find Suspicious Labels...',...
  'Tag','menu_label_outliers');  %#ok<NASGU>

menu_label_set_labels = uimenu('Parent',menu_label,...
  'Label','Import Tracking Predictions as Labels',...
  'Tag','menu_label_set_labels',...
  'Separator','on');  %#ok<NASGU>
...
menu_track_tag_tracker = ...
  uimenu('Parent',menu_track, ...
         'Label','Tag Tracker...', ...
         'Tag','menu_track_tag_tracker') ;  %#ok<NASGU>
...
menu_track_backend_config = uimenu( ...
  ...
  'Visible','on',...
  'Separator','on',...
  'Tag','menu_track_backend_config');  %#ok<NASGU>
...
menu_track_edit_skeleton = ...
  uimenu('Parent',menu_track,...
         ...
         'Tag','menu_track_edit_skeleton') ;  %#ok<NASGU>

% Going to comment this out b/c this functionality doesn't work correctly
% at the moment.  User can start training and look at the training images
% as a workaround for now.  --ALT, 2026-03-19
% menu_track_viz_dataaug = ...
%   uimenu('Parent',menu_track,...
%          'Label','Show Sample Training Images...',...
%          'Tag','menu_track_viz_dataaug') ;  %#ok<NASGU>
...
menu_evaluate_show_uncertain_frames = uimenu('Parent', menu_evaluate, ...
  'Label', 'Show Uncertain Frames...', ...
  'Tag', 'menu_evaluate_show_uncertain_frames', ...
  'Separator', 'off') ;  %#ok<NASGU>

menu_evaluate_compare_trackers = uimenu('Parent', menu_evaluate, ...
  'Label', 'Compare Trackers...', ...
  'Tag', 'menu_evaluate_compare_trackers', ...
  'Separator', 'off') ;  %#ok<NASGU>
...
menu_help_doc = uimenu(...
  ...
  'Tag','menu_help_doc');  %#ok<NASGU>

menu_help_labeling_actions = uimenu(...
'Parent',menu_help,...
'Label','Labeling Actions',...
'Tag','menu_help_labeling_actions');  %#ok<NASGU>

menu_help_about = uimenu(...
  'Parent',menu_help,...
  'Label','About APT',...
  'Tag','menu_help_about');  %#ok<NASGU>
...
if ispc() && isequal(get(pumTimelineProp,'BackgroundColor'), get(groot(),'defaultUicontrolBackgroundColor'))
    set(pumTimelineProp,'BackgroundColor','white');
end
...
pumTimelinePropType = uicontrol(...
'Parent',main_figure,...
'Units','pixels',...
'String',{ 'Labels'; 'Predictions' },...
'Style','popupmenu',...
'Value',1,...
'BackgroundColor',[0 0 0],...
'ForegroundColor',[1 1 1],...
'Tag','pumTimelinePropType',...
'FontUnits','pixels',...
'FontSize',11);

% Hint: popupmenu controls usually have a white background on Windows.
%       See ISPC and COMPUTER.
if ispc() && isequal(get(pumTimelinePropType,'BackgroundColor'), get(groot(),'defaultUicontrolBackgroundColor'))
    set(pumTimelinePropType,'BackgroundColor','white');
end
...
% Disable auto-resize so that LabelerController.layoutMainFigure_() is in full control
main_figure.AutoResizeChildren = 'off' ;
uipanel_curr.AutoResizeChildren = 'off' ;

% Make sure the APT window is not bigger than the screen
figSetPosAPTDefault(main_figure);

% Control positions will be set by LabelerController.layoutMainFigure_() after construction.
