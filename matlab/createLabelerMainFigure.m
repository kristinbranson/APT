...
menu_view_showhide_labels = uimenu(...
  'Parent',menu_view_showhide,...
  'Label','Show labels',...
  'Tag','menu_view_showhide_labels',...
  'Separator','on',...
  'CreateFcn', '' );
...
menu_file_import_labels_table = ...
  uimenu('Parent',handles.menu_file_import,...
...
menu_file_import_labels_cocojson = ...
  uimenu('Parent',handles.menu_file_import,...
         ...
         'Visible','on') ;
moveMenuItemAfter(menu_file_import_labels_cocojson,...
  menu_file_import_labels_table);

menu_file_export_all_movies = ...
  uimenu('Parent',handles.menu_file_export,...
...
moveMenuItemAfter(menu_file_clear_imported, ...
                  menu_file_import_predictions);

% % make a subheading for exporting training data/labels
% menu_file_export_labels = ...
%   uimenu('Parent',handles.menu_file_importexport,...
%          'Label','Export Labels',...
%          'Tag','menu_file_export_labels',...
%          'Checked','off',...
%          'Visible','on') ;
% moveMenuItemAfter(menu_file_export_labels,...
%                   menu_file_clear_imported);
...
menu_file_export_cocojson = ...
  uimenu('Parent',menu_file_export,...
         ...
         'Checked','off',...
         'Visible','on');
moveMenuItemAfter(menu_file_export_cocojson,...
                  menu_file_export_labels_table);

% menu_file_export_stripped_lbl = ...
%   uimenu('Parent',menu_file_export,...
%          'Label','Export Project to Stripped Lbl file...',...
