...
menu_setup_sequential_add_mode = uimenu('Parent',menu_label,...
  'Label','Add Landmarks Mode',...
  'Tag','menu_setup_sequential_add_mode',...
  'Visible','off');  %#ok<NASGU>

menu_setup_streamlined = uimenu('Parent',menu_label,...
  'Label','Streamlined',...
...
menu_setup_ma_twoclick_align = uimenu('Parent',menu_label,...
...
menu_setup_label_outliers = uimenu('Parent',menu_label,...
  'Label','Find Suspicious Labels...',...
  'Tag','menu_setup_label_outliers');  %#ok<NASGU>

menu_track_set_labels = uimenu('Parent',menu_label,...
