...
% Disable auto-resize so that layoutMainFigureBang is in full control
...
% Set all control positions from the current figure size
layoutMainFigureBang(main_figure) ;
