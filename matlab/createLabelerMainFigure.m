...
% Go menu
menu_go = uimenu('Parent',main_figure,'Position',4,'Label','Go');
menu_go_targets_summary = uimenu('Parent',menu_go,...
  'Label','Switch targets...',...
  'Tag','menu_go_targets_summary',...
  'Separator','off',...
  'Checked','off');
menu_go_movies_summary = uimenu('Parent',menu_go,...
  'Label','Switch movies...',...
  'Tag','menu_go_movies_summary',...
  'Separator','off',...
  'Checked','off');
menu_go_nav_prefs = uimenu('Parent',menu_go,...
  'Label','Navigation preferences...',...
  'Tag','menu_go_nav_prefs',...
  'Separator','off',...
  'Checked','off');
menu_go_gt_frames = uimenu('Parent',menu_go,...
  'Label','GT frames',...
