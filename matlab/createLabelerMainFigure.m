...
menu_view_show_trajectories = ...
  uimenu('Parent',handles.menu_view,...
         ...
         'Tag','menu_view_show_trajectories');
menu_view_show_trajectories_current_target_only = ...
  uimenu('Parent',handles.menu_view,...
         'Label','Show trajectories only for current target',...
         'Tag','menu_view_show_trajectories_current_target_only');
moveMenuItemAfter(menu_view_show_trajectories_current_target_only,...
                  menu_view_show_trajectories);
