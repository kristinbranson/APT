...
% "kick" is short for "sidekick".  This is the small reference/previous-frame axes in the upper left.
axes_kick = axes(...
'Parent',uipanel_kick,...
'FontUnits','pixels',...
'Units','pixels',...
...
'CreateFcn', '' ,...
'Tag','popupmenu_kick_mode',...
'FontSize',13.3333333333333,...
'FontSizeMode',get(0,'defaultuicontrolFontSizeMode'));

if ispc() && isequal(get(popupmenu_kick_mode,'BackgroundColor'), get(groot(),'defaultUicontrolBackgroundColor'))
    set(popupmenu_kick_mode,'BackgroundColor','white');
end


pushbutton_freeze_template = uicontrol(...
'Parent',uipanel_kick,...
'Units',get(0,'defaultuicontrolUnits'),...
'FontUnits','pixels',...
'String','Freeze',...
...
'Tag','pushbutton_freeze_template',...
'FontSize',13.3333333333333,...
'FontSizeMode',get(0,'defaultuicontrolFontSizeMode'),...
'CreateFcn', '' );
...
set(handles.txKickIm,'String','');
set(handles.edit_frame,'String','');
set(handles.popupmenu_kick_mode,'Enable','off');
set(handles.pushbutton_freeze_template,'Enable','off');
...
% Do stuff to axes_kick
image_kick = imagesc(0,'Parent',handles.axes_kick,'Tag','image_kick');
set(image_kick,'PickableParts','none');
hold(handles.axes_kick,'on');
set(handles.axes_kick,'Color',[0 0 0],'Tag','axes_kick');
