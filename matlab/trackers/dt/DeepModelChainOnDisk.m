...
%         obj.view,obj.trkTSstr);
  ...
  methods
    ...
    function fileinfo = trainFileInfo(obj,use,varargin)  
      % to do: use can specify whether this is for docker etc. currently
      % all the same

      cntrPathFcn = myparse(varargin,...
       'containerPathConvertFcn',@(x)x ...
       );
      ...
      % tfIncLog could prob always be true; had been issues in past but may
      ...
      fileinfo = struct(...
        ...
        'dlconfig',cntrPathFcn(obj.trainConfigLnx),...
        'trainlocfile',cntrPathFcn(obj.trainLocLnx),...
        'cache',cntrPathFcn(obj.rootDir),...
        'useLogfileArg',tfIncLog,... 
        'logfile',cntrPathFcn(logfile),...
        'errfile',cntrPathFcn(obj.errfileLnx),...
        'nettype',netTypeObj,...
        'netmode',obj.netMode);
    end
