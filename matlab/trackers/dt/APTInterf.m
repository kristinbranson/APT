...
%     end
    ...
    function [codestr,code] = bboxTrainCodeGen(trnID,dllbl,cache,errfile,...
      ...
      warningNoTrace('BBox params TODO');
      code = { ...
        ['TORCH_HOME=' filequote torchhome filequote] ...
        'python' ...
        [filequote aptintrf filequote] ...
    ...
    function [codestr,code] = bboxPoseTrainCodeGen(trnID,dllbl,cache,errfile,...
        netType,trnjson,varargin)      
      ...
      warningNoTrace('Pose/ObjDetect params TODO');
      code = { ...
        ['TORCH_HOME=' filequote torchhome filequote] ...
        'python' ...
        [filequote aptintrf filequote] ...
        ...
        '-conf_params' ...
        'db_format' [confparamsfilequote 'tfrecord' confparamsfilequote] ... % when the job is submitted the double quote need to escaped. This is tested fro cluster. Not sure for AWS etc. MK 20210226
        'rrange' '180' ... % TODO: params
        'trange' '20' ... % TODO: params
        'imsz' '\(181,181\)' ... % TODO: params
        'use_bbox_trx' 'True' ...
        '-type' netType ...
        '-cache' [filequote cache filequote] ... % String.escapeSpaces(cache),...
        'train' ...
