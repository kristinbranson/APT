...
%       'jrcgpuqueue' 'jrcnslots' 'jrcnslotstrack'}; 
  ...
  properties
    ...
    movIdx2trkfile % map from MovieIndex.id to [ ntrk x nview ] cellstrs of trkfile fullpaths
      % movIdx2trkfile holds the "ad-hoc" tracking results, i.e. those generated by
...
%         end
      ...
      % % 2026-02-25: Took movIdx2trkfile out of SAVEPROPS
      % % 20190415
