...
%       end
    ...
    function retrain(obj,varargin)
      ...
      [wbObj,dlTrnType,oldVizObj,augOnly,do_just_generate_db] = myparse(varargin,...
        'wbObj',[],...
      ...
      switch trnBackEnd.type
        case {DLBackEnd.Bsub DLBackEnd.Conda DLBackEnd.Docker}
          obj.trnSpawn(trnBackEnd,dlTrnType,modelChain,...
            'wbObj',wbObj,'prev_models',prev_models,'augOnly',augOnly,'do_just_generate_db',do_just_generate_db);
        case DLBackEnd.AWS
