classdef BgTrackWorkerObjAWS < BgWorkerObjAWS & BgTrackWorkerObj 
  methods    
    ...
    function sRes = workOnMovie(obj, logger)
      ...
      logger.log('Inside BgTrackWorkerObjAWS::workOnMovie()') ;
      ...
      %logger.log('BgTrackWorkerObjAWS::workOnMovie() milestone 1\n') ;
      ...
      logger.log(sprintf('BgTrackWorkerObjAWS::workOnMovie(): errfiles{1}: %s', errfiles{1})) ;
      logger.log(sprintf('BgTrackWorkerObjAWS::workOnMovie(): logfiles{1}: %s', logfiles{1})) ;
      logger.log(sprintf('BgTrackWorkerObjAWS::workOnMovie(): parttrkfiles{1}: %s', parttrkfiles{1})) ;
      logger.log(sprintf('BgTrackWorkerObjAWS::workOnMovie(): trkfiles{1}: %s', trkfiles{1})) ;
      
      % KB 20190115: also get locations of part track files and timestamps
      % of last modification
      %logger.log('BgTrackWorkerObjAWS::workOnMovie() milestone 2\n') ;
      ...
      %logger.log('BgTrackWorkerObjAWS::workOnMovie() milestone 2.1\n') ;
      for i = 1:numel(parttrkfiles),
        %logger.log('BgTrackWorkerObjAWS::workOnMovie() milestone 2.2\n') ;
        parttrkfilecurr = parttrkfiles{i};
        %logger.log('BgTrackWorkerObjAWS::workOnMovie() milestone 2.3\n') ;
        does_file_exist = obj.fileExists(parttrkfilecurr) ;
        %logger.log('BgTrackWorkerObjAWS::workOnMovie() milestone 2.4\n') ;
        if does_file_exist ,
          %logger.log('BgTrackWorkerObjAWS::workOnMovie() milestone 2.5\n') ;
          ...
          %logger.log('BgTrackWorkerObjAWS::workOnMovie() milestone 2.6\n') ;
          ...
          %logger.log('BgTrackWorkerObjAWS::workOnMovie() milestone 2.7\n') ;
        else
      ...
      %logger.log('BgTrackWorkerObjAWS::workOnMovie() milestone 3\n') ;
      tfComplete = false(size(trkfiles)) ;
      trkfileNfrmtracked = nan(size(trkfiles)); % nmovies x nviews x nstages
      %logger.log('BgTrackWorkerObjAWS::workOnMovie() milestone 3.1\n') ;
      for i = 1:numel(trkfileNfrmtracked),
        %logger.log('BgTrackWorkerObjAWS::workOnMovie() milestone 3.2\n') ;
        trkfilecurr = trkfiles{i};
        %logger.log('BgTrackWorkerObjAWS::workOnMovie() milestone 3.3\n') ;
        does_file_exist = obj.fileExists(trkfilecurr) ;
        %logger.log('BgTrackWorkerObjAWS::workOnMovie() milestone 3.4\n') ;
        tfComplete(i) = does_file_exist ;
        if does_file_exist ,
          %logger.log('BgTrackWorkerObjAWS::workOnMovie() milestone 3.5\n') ;
      ...
      %logger.log('BgTrackWorkerObjAWS::workOnMovie() milestone 4\n') ;
      ...
      %logger.log('BgTrackWorkerObjAWS::workOnMovie() milestone 5\n') ;
      sRes = struct(...
      ...
      logger.log('About to exit BgTrackWorkerObjAWS::workOnMovie().') ;
    end  % function   
  end  % methods
end  % classdef
