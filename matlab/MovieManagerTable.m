classdef MovieManagerTable < handle
  ...
  properties (Constant)
    JTABLEPROPS_NOTRX = {'ColumnName',{'ID' 'Movie' 'Num Labels'},...
                         'ColumnPreferredWidth',[25 575 250],...
                         'ColumnFormat',{'integer' 'char' 'integer'}};
    JTABLEPROPS_TRX = {'ColumnName',{'ID' 'Movie' 'Trx' 'Num Labels'},...
                       'ColumnFormat',{'integer' 'char' 'char' 'integer'},...
                       'ColumnPreferredWidth',[25 525 200 100]};
  end
  properties
    hParent
    cbkSelectMovie
