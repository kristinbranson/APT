...
handles.menu_view_show_preds_curr_target_only = uimenu('Parent',handles.menu_view,...
  ...
  'Checked','off');
moveMenuItemAfter(handles.menu_view_show_preds_curr_target_only,handles.menu_view_hide_predictions);
...
handles.menu_view_hide_imported_predictions = uimenu('Parent',handles.menu_view,...
  ...
  'Checked','off');
moveMenuItemAfter(handles.menu_view_hide_imported_predictions,handles.menu_view_show_preds_curr_target_only);
...
SetStatus(handles,'Defining landmark matches...');
lObj = handles.labelerObj;
