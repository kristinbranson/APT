function [vidobj] = MakeTrackingResultsHistogramVideo3(expdirs,trxfile,varargin)
...
[firstframe,endframe,moviefilestr,resvideo,smoothsig,maxv,...
  ...
  CurrMarkerSize,CurrLineWidth,visible,cropframelims,followfly] = ...
